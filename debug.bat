g++ src\main.cpp src\string_funcs.cpp src\ui.cpp src\play_engine.cpp -o cities.exe -Wshadow -Winit-self -Wredundant-decls -Wcast-align -Wundef -Wfloat-equal -Winline -Wunreachable-code ^
...
-D _EJUDGE_CLIENT_SIDE -D VERSION_DEBUG -I include
