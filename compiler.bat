g++ main.cpp string_funcs.cpp ui.cpp play_engine.cpp TXLib.o -o cities.exe -Wshadow -Winit-self -Wredundant-decls -Wcast-align -Wundef -Wfloat-equal -Winline -Wunreachable-code ^
